...
public class EqEffect extends Effect {
    ...
    private static final String TAG = "EFFECTS-PLAYBACK";
...
//            effect.setEnabled( params[0].equals(ON) );
    ...
    private void setEffectProperties() {
        ...
        short bandLevels[] = convertParamsToSettings(eq);
     ...
     */
    private short[] convertParamsToSettings(Equalizer eq) {
        // TODO
        // may want to pass in eq.getNumberOfBands() instead of trying to set that
        // via Equalizer.Settings
