...
//    @Override
//    public void onButtonClicked(int track, String effect) {
//        if (effect.equals("EQ")) {
...
//        View layout;
//        if (effect.equals("EQ")) {
//            layout = getActivity().getLayoutInflater().inflate(R.layout.eq_canvas,
//                    (ViewGroup) activity.findViewById(R.id.eqCanvasParent), false);
//        } else {
//            layout = getActivity().getLayoutInflater().inflate(R.layout.reverb_canvas,
//                    (ViewGroup) activity.findViewById(R.id.eqCanvasParent), false);
//        }
//
//        imageDialog.setView(layout);
...
////        Fx_EQCanvas effectCanvas = (Fx_EQCanvas) layout.findViewById(R.id.effect_canvas);
...
////        Fx_ReverbCanvas reverbCanvas = (Fx_ReverbCanvas) layout.findViewById(R.id.effect_canvas);
//
